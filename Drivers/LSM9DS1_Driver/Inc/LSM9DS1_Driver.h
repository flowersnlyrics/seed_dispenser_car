 ...
 * @date *2019-04-08 Mon 12:14 AM* 
 * @brief A driver for interfacing with the LSM9DS1 Magnetometer/Accelerometer/Gyroscope chip
...
extern SPI_HandleTypeDef hspi1;                 /**< Spi Handle for interfacing with HAL Drivers*/

//Defines 
#define LSM9DS1_READ_MODE                  (0x01 << 7) 
#define LSM9DS1_WRITE_MODE                 (0x00 << 7)
#define SPI_TIMEOUT                        HAL_MAX_DELAY//1000 /**< Spi Timeout set for 1000ms */
#define MAGTYPE                            (true) 
#define MAG_MAX_REG_NUM                    0x0033 /**< Maximum number of registers in the magnetometer sensor */
#define XGTYPE                             (false)
#define XG_MAX_REG_NUM                     0x007F /**< Maximum number of registers in the accel-gyroscope sensor */
#define LSM9DS1_READ                       (true) /**< Read operation */
#define LSM9DS1_WRITE                      (false) /**< Write operation */
...
typedef enum
{
    LSM9DS1_OK,                                 /**< LSM9DS1 operation is normtal */
    LSM9DS1_INIT_ERR,                           /**< LSM9DS1 initialization error */
} LSM9DS1_status_t; 
...
/*!
 * Run a register operation(Read or Write) 
 ...
 * @param buf Pointer to transmit buffer or receive buffer
 * @param num_bytes Number of registers to read or write
 */
